...
string number_It_20_to_string(int number)
{
	...
	if (number>999){
		...
		switch(n)
		{
		case 1: answer += "тыс€ча"; break;
		case 2: answer += "две тыс€чи"; break;
		case 3: answer += "три тыс€чи"; break;
		case 4: answer += "четыре тыс€чи"; break;
		case 5: answer += "п€ть тыс€ч"; break;
		case 6: answer += "шесть тыс€ч"; break;
		case 7: answer += "семь тыс€ч"; break;
		case 8: answer += "восемь тыс€ч"; break;
		case 9: answer += "дев€ть тыс€ч"; break;
		default: break;
		}
		answer += " ";
	...
	if  ((number < 100)&&(number >19) ){
		...
		case 5: answer += "п€тьдес€т"; break;
		case 6: answer += "шестьдес€т"; break;
		case 7: answer += "семьдес€т"; break;
		case 8: answer += "восемьдес€т"; break;
		case 9: answer += "дев€носто"; break;
		default: break;
		}
